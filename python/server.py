...
REPORT_CHECK_API_KEY = os.getenv('REPORT_CHECK_API_KEY')
REPORT_CHECK_API_ENDPOINT = os.getenv('REPORT_CHECK_API_ENDPOINT')
...
# These examples are available with a sandbox API key
